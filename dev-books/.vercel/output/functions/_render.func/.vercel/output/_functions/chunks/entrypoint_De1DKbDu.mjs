import { R as ROUTE_TYPE_HEADER, y as REROUTE_DIRECTIVE_HEADER, A as AstroError, z as i18nNoLocaleFoundInPath, B as ResponseSentError, C as bold, G as red, H as yellow, J as dim, K as blue, O as MiddlewareNoDataOrNextCalled, P as MiddlewareNotAResponse, Q as GetStaticPathsRequired, S as InvalidGetStaticPathsReturn, T as InvalidGetStaticPathsEntry, V as GetStaticPathsExpectedParams, W as GetStaticPathsInvalidRouteParam, X as PageNumberParamNotFound, Y as decryptString, Z as createSlotValueFromString, r as renderTemplate, d as renderComponent, D as DEFAULT_404_COMPONENT, _ as EnvUnsupportedGetSecret, $ as NoMatchingStaticPathFound, a0 as PrerenderDynamicEndpointPathCollide, a1 as ReservedSlotName, a2 as renderSlotToString, a3 as renderJSX, a4 as chunkToString, a5 as isRenderInstruction, a6 as LocalsReassigned, a7 as clientAddressSymbol$1, a8 as PrerenderClientAddressNotAvailable, a9 as ClientAddressNotAvailable, aa as StaticClientAddressNotAvailable, ab as RewriteWithBodyUsed, ac as ASTRO_VERSION, ad as AstroResponseHeadersReassigned, ae as responseSentSymbol$1, af as renderPage, ag as REWRITE_DIRECTIVE_HEADER_KEY, ah as REWRITE_DIRECTIVE_HEADER_VALUE, ai as renderEndpoint, aj as LocalsNotAnObject, ak as clientLocalsSymbol, al as REROUTABLE_STATUS_CODES, am as commonjsGlobal } from './astro/server_BWafY5Bs.mjs';
import { a as appendForwardSlash, j as joinPaths, t as trimSlashes, f as fileExtension, s as slash$1, p as prependForwardSlash, b as removeTrailingForwardSlash } from './path_I7weJv-K.mjs';
import { g as getActionQueryString, d as deserializeActionResult, e as ensure404Route, a as default404Instance, D as DEFAULT_404_ROUTE } from './astro-designed-error-pages_D-P0SqZC.mjs';
import { a as setGetEnv } from './setup_qUz3GmrZ.mjs';
...
class Pipeline {
  constructor(logger, manifest, mode, renderers, resolve, serverLike, streaming, adapterName = manifest.adapterName, clientDirectives = manifest.clientDirectives, inlinedScripts = manifest.inlinedScripts, compressHTML = manifest.compressHTML, i18n = manifest.i18n, middleware = manifest.middleware, routeCache = new RouteCache(logger, mode), site = manifest.site ? new URL(manifest.site) : void 0, callSetGetEnv = true, defaultRoutes = createDefaultRoutes(manifest)) {
    ...
    if (callSetGetEnv && manifest.envGetSecretEnabled) {
      setGetEnv(() => {
        throw new AstroError(EnvUnsupportedGetSecret);
      }, true);
    }
  }
  internalMiddleware;
...
await import('./setup_qUz3GmrZ.mjs').then(n => n.b)
